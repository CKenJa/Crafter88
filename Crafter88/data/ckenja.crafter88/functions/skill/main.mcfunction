...
# スキルIDにアクセスして
    execute store result storage rom: Argument.ID int 1 run data get storage ckenja.crafter88: right_click.SelectedItem.tag.ckenja.crafter88.skill.id

    function rom:api/please

# 保存時の方向を取得して方向を修正
    execute store result score $skill.direction.fix ckenja.crafter88 run data get storage rom: _[-4][-4][-4][-4][-4][-4][-4][-4].ckenja.crafter88.skill.direction
...
# 合う方向の構造物IDを得る
    execute store result score $tmp.id ckenja.structure_memory run data get storage rom: _[-4][-4][-4][-4][-4][-4][-4][-4].ckenja.crafter88.skill.0
    ...
    execute if score $skill.direction ckenja.crafter88 matches 270 store result score $tmp.id ckenja.structure_memory run data get storage rom: _[-4][-4][-4][-4][-4][-4][-4][-4].ckenja.crafter88.skill.270
