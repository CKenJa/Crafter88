#> ckenja.crafter88:tick/player/launch_vector.loop
#
#
#
# @within function ckenja.crafter88:tick/player/launch_vector
...
execute unless data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ckenja.crafter88.place.marker.attackDirections[-1].self run function ckenja.crafter88:tick/player/launch_vector.self
...
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ckenja.crafter88.place.marker.attackDirections[-1] run function ckenja.crafter88:tick/player/launch_vector.loop
