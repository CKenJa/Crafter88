...
execute if score $place.marker.tick.counter ckenja.crafter88 matches ..1 run damage @s 2 player_attack
execute if score $place.marker.tick.counter ckenja.crafter88 matches 2.. run damage @s 1 player_attack
#$strength
