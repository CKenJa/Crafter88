...
# これの処理順をミスると一瞬で外れる
    execute if score $marker.tick.counter ckenja.crafter88 matches ..1 run attribute @s generic.movement_speed modifier remove c145c31f-0f69-4e87-a826-0227fe45323c
