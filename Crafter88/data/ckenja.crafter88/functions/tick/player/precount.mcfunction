...
# これの処理順をミスると一瞬で外れる
    execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ckenja.crafter88.place.marker.tick{counter:1} run attribute @s generic.movement_speed modifier remove c145c31f-0f69-4e87-a826-0227fe45323c
